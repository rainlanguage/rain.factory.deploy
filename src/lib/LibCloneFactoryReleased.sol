...
import {
    ...
    RUNTIME_CODE as CloneFactory_0_1_9_RUNTIME_CODE,
    DEPENDENCIES as CloneFactory_0_1_9_DEPENDENCIES
} from "../generated/0_1_9/CloneFactory.sol";

import {
    DEPLOYED_ADDRESS as CloneFactory_0_1_10_DEPLOYED_ADDRESS,
    BYTECODE_HASH as CloneFactory_0_1_10_BYTECODE_HASH,
    CREATION_CODE as CloneFactory_0_1_10_CREATION_CODE,
    RUNTIME_CODE as CloneFactory_0_1_10_RUNTIME_CODE,
    DEPENDENCIES as CloneFactory_0_1_10_DEPENDENCIES
} from "../generated/0_1_10/CloneFactory.sol";
...
library LibCloneFactoryReleased {
    ...
    function releasedSuites() internal pure returns (DeploySuite[] memory) {
        ...
        suites[0] = DeploySuite({
            ...
            storedBytecodeHash: CloneFactory_0_1_9_BYTECODE_HASH,
            storedRuntimeCode: CloneFactory_0_1_9_RUNTIME_CODE,
        ...
        suites[1] = DeploySuite({
            ...
            storedBytecodeHash: CloneFactory_0_1_10_BYTECODE_HASH,
            storedRuntimeCode: CloneFactory_0_1_10_RUNTIME_CODE,
            artifactPath: "src/concrete/CloneFactory.sol:CloneFactory",
            dependencies: abi.decode(CloneFactory_0_1_10_DEPENDENCIES, (address[]))
        });
        return suites;
    }
}
